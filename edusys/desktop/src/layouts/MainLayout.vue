  ...
  <el-container class="main-layout">
    ...
    <el-drawer v-model="drawerVisible" direction="ltr" size="220px" :show-close="false" class="mobile-drawer">
      ...
      >
        ...
        <el-sub-menu index="/system" v-if="hasAnyPermission(['user:list', 'role:list', 'permission:list', 'system-info:view', 'menu:list'])">
          <template #title>
          ...
          <el-menu-item index="/menu" v-if="hasPermission('menu:list')">菜单管理</el-menu-item>
          <el-menu-item index="/system-info" v-if="hasPermission('system-info:view')">基础信息</el-menu-item>
        </el-sub-menu>
        <el-sub-menu index="/exam" v-if="hasAnyPermission(['exam:list', 'exam-session:list', 'exam-venue:list', 'exam-room:list', 'exam-arrangement:list', 'score:list'])">
          <template #title>
            <el-icon><Document /></el-icon>
            <span>考试管理</span>
          </template>
          <el-menu-item index="/exam" v-if="hasPermission('exam:list')">考试安排</el-menu-item>
          <el-menu-item index="/exam-session" v-if="hasPermission('exam-session:list')">考试场次</el-menu-item>
          <el-menu-item index="/exam-venue" v-if="hasPermission('exam-venue:list')">考点管理</el-menu-item>
          <el-menu-item index="/exam-room" v-if="hasPermission('exam-room:list')">考场管理</el-menu-item>
          <el-menu-item index="/exam-arrangement" v-if="hasPermission('exam-arrangement:list')">考试编排</el-menu-item>
...
import { HomeFilled, Setting, Fold, Expand, School, Menu, ArrowDown, User, SwitchButton, Document } from '@element-plus/icons-vue'
