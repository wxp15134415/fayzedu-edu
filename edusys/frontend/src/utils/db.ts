...
type DbTables = {
  ...
  grades: typeof db.grades
  classes: typeof db.classes
  subjects: typeof db.subjects
  scores: typeof db.scores
  exams: typeof db.exams
  users: typeof db.users
  roles: typeof db.roles
  syncQueue: typeof db.syncQueue
  settings: typeof db.settings
}

// 导出便捷方法
export const localDB = {
  // 通用方法
  async clear(tableName: keyof DbTables) {
    const tableMap: DbTables = {
    ...
    return await tableMap[tableName].clear()
  },
