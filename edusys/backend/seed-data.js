...
const dataSource = new DataSource({
  ...
  database: 'edusys',
  entities: [
    require('./dist/src/entities/grade.entity'),
    require('./dist/src/entities/class.entity'),
    require('./dist/src/entities/student.entity'),
    require('./dist/src/entities/subject.entity'),
    require('./dist/src/entities/score.entity')
  ],
  synchronize: false
})
