...
async function seed() {
  ...
  const permissions = [
    ...
    { permissionName: '考试场次', permissionCode: 'exam-session:list', permissionDesc: '考试场次列表' },
    { permissionName: '考点管理', permissionCode: 'exam-venue:list', permissionDesc: '考点管理列表' },
    { permissionName: '考场管理', permissionCode: 'exam-room:list', permissionDesc: '考场管理列表' },
    { permissionName: '考试编排', permissionCode: 'exam-arrangement:list', permissionDesc: '考试编排列表' }
  ]
