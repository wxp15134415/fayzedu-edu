  ...
  actions: {
    ...
    async initAuthRoute() {
      ...
      try {
        ...
        const appRoot = router.getRoutes().find(r => r.path === '/appRoot')
        console.log('[DEBUG] appRoot children:', appRoot?.children?.map(c => ({ path: c.path, name: c.name, component: !!c.component })))

        // Generate side menu
        this.menus = createMenus(rowRoutes)
        console.log('[DEBUG] Generated menus:', JSON.stringify(this.menus, null, 2))
